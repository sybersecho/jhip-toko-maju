...
export class ProductService {
    ...
    findProductsOfSupplierContains(id: number, currentSearch: any): Observable<EntityArrayResponseType> {
        const options = new HttpParams().set('name.contains', currentSearch).set('supplierId.equals', id.toString());
        return this.http.get<IProduct[]>(this.resourceUrl, { params: options, observe: 'response' });
    }
