...
export class GeraiComponent implements OnInit, OnDestroy {
    currentAccount: any;
    gerais: IGerai[];
    error: any;
    success: any;
    ...
    trackId(index: number, item: IGerai) {
        return item.id;
    }

    registerChangeInGerais() {
        this.eventSubscriber = this.eventManager.subscribe('geraiListModification', response => this.loadAll());
    }
