...
public class DuePaymentServiceImpl implements DuePaymentService {
    ...
    public DuePaymentServiceImpl(DuePaymentRepository duePaymentRepository, DuePaymentMapper duePaymentMapper, DuePaymentSearchRepository duePaymentSearchRepository) {
    ...
    public Page<DuePaymentDTO> findAll(Pageable pageable) {
        ...
        return duePaymentRepository.findAll(pageable)
    ...
    public Page<DuePaymentDTO> search(String query, Pageable pageable) {
        ...
        return duePaymentSearchRepository.search(queryStringQuery(query), pageable)
            .map(duePaymentMapper::toDto);
    }
}
