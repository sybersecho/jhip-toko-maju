...
public class SaleTransactionsServiceImpl implements SaleTransactionsService {
    ...
    public SaleTransactionsServiceImpl(SaleTransactionsRepository saleTransactionsRepository, SaleTransactionsMapper saleTransactionsMapper, SaleTransactionsSearchRepository saleTransactionsSearchRepository) {
    ...
    public Optional<SaleTransactionsDTO> findOne(Long id) {
        ...
        return saleTransactionsRepository.findById(id)
            .map(saleTransactionsMapper::toDto);
    }
    ...
    public void delete(Long id) {
        log.debug("Request to delete SaleTransactions : {}", id);        saleTransactionsRepository.deleteById(id);
