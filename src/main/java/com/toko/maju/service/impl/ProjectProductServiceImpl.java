...
public class ProjectProductServiceImpl implements ProjectProductService {
    ...
    public ProjectProductServiceImpl(ProjectProductRepository projectProductRepository, ProjectProductMapper projectProductMapper, ProjectProductSearchRepository projectProductSearchRepository) {
    ...
    public Page<ProjectProductDTO> findAll(Pageable pageable) {
        ...
        return projectProductRepository.findAll(pageable)
    ...
    public Optional<ProjectProductDTO> findOne(Long id) {
        ...
        return projectProductRepository.findById(id)
            .map(projectProductMapper::toDto);
    }
    ...
    public void delete(Long id) {
        log.debug("Request to delete ProjectProduct : {}", id);        projectProductRepository.deleteById(id);
