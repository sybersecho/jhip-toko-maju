...
import { ReturnTransactionComponent } from 'app/entities/return-transaction/return-transaction.component';
...
describe('Component Tests', () => {
    describe('ReturnTransaction Management Component', () => {
        let comp: ReturnTransactionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReturnTransactionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ReturnTransaction(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.returnTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
