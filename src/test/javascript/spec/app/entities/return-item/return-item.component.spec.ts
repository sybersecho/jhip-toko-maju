...
import { ReturnItemComponent } from 'app/entities/return-item/return-item.component';
...
describe('Component Tests', () => {
    describe('ReturnItem Management Component', () => {
        let comp: ReturnItemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReturnItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.returnItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
