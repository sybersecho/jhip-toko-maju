...
import { SaleItemComponent } from 'app/entities/sale-item/sale-item.component';
...
describe('Component Tests', () => {
    describe('SaleItem Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.saleItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
