...
describe('Service Tests', () => {
    describe('SaleItem Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SaleItem', async () => {
            ...
            it('should update a SaleItem', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantity: 1,
                        totalPrice: 1
            ...
            it('should return a list of SaleItem', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantity: 1,
                        totalPrice: 1
            ...
            it('should delete a SaleItem', async () => {
