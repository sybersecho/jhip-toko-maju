...
import { CancelTransactionComponent } from 'app/entities/cancel-transaction/cancel-transaction.component';
...
describe('Component Tests', () => {
    describe('CancelTransaction Management Component', () => {
        let comp: CancelTransactionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CancelTransactionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new CancelTransaction(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.cancelTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
